import type { HampelConfig } from "../filters/hampel-config";
import type { KalmanConfig } from "../filters/kalman-config";
import type { SpeedGateConfig } from "../filters/speed-gate-config";
